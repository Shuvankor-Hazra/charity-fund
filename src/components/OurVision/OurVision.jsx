        ...
        <div className="container my-16 bg-white dark:bg-gray-900 dark:text-white">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                <motion.div
                    ...
                    <p>Seamlessly engineer cross-media ROI and covalent relationships. Holistically exploit synergistic applications without unique outside the box thinking. Progressively synthesize proactive.</p>
                ...
                <motion.div
                    ...
                    <p>Efficiently initiate multimedia based quality vectors via reliable e-services. Competently integrate premier imperatives with interoperable applications. Proactively strategics compelling information.</p>
                    <a href="#" className="inline-block hover:text-primary border-b-2  hover:border-primary">Learn More</a>
                </motion.div>
            </div>
        </div>
